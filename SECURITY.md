...
This policy applies to **`Kenearos/Rentenversicherer`**. It is derived from our engineering
...
1. Email **kenearos@googlemail.com** with the subject prefix `[SECURITY] Rentenversicherer`.
...
| Version | Supported |
|---------|-----------|
| Latest release of `Rentenversicherer` | ✅ Yes |
